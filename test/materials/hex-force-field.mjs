...
export default class HexForceField extends Materials {
  constructor(name) {
    super(name);
    this.name = name;
    this.type = null;
  ...
  static HexForceFieldGroupGroup(strength_0, fac_1, scrollZ_2, scrollWave_3) {
    var material = new HexForceField('HexForceFieldGroup')
    material.type = 'GROUP';
  ...
  static HexForceFieldMat_(args) {
    ...
    return HexForceField.HexForceFieldMat(hexForceFieldGroupStrength_0, hexForceFieldGroupFac_1, hexForceFieldGroupScrollZ_2, hexForceFieldGroupScrollWave_3)
  }
  static HexForceFieldMat(hexForceFieldGroupStrength_0, hexForceFieldGroupFac_1, hexForceFieldGroupScrollZ_2, hexForceFieldGroupScrollWave_3) {
    var material = new HexForceField('HexForceFieldMat')
    material.isGroup = true;
    material.type = 'GROUP';
    material.conversion = {
